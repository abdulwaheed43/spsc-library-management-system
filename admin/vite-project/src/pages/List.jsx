...
const List = ({ token }) => {
  ...
  return (
    <>
      <p className="mb-3 text-xl font-bold">🍔 All Food Items</p>

      {/* HEADER */}
      <div className="hidden md:grid grid-cols-[1fr_2fr_1fr_1fr_1fr_1fr] items-center py-2 px-3 border bg-[#d4a257] text-black font-semibold rounded">
        <b>Image</b>
        <b>Name</b>
        <b>Category</b>
        <b>Type</b>
        ...
        {list.map((item, index) => (
          ...
          >
            ...
            <img
              src={item.image?.[0]}
              alt={item.name}
              className="w-14 h-14 object-cover rounded text-black"
            />
            ...
            {/* FOOD TYPE */}
            <p className={`font-semibold ${item.foodType === "Veg" ? "text-green-600" : "text-black "}`}>
              {item.foodType}
            </p>
            ...
            <p
              ...
              className="text-red-700  font-bold cursor-pointer hover:text-red-700"
            >
              Delete
            </p>
